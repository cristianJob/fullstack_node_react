...
export async function newProductAction({ request }: ActionFunctionArgs) {
    ...
    // siempre debe estar para no generar errores
    return redirect('/')
}
...
export default function NewProduct() {
    ...
    //obtiene los datos que llegar del return de la funcion
    const error = useActionData() as string
    return (
        <>
            <div className="flex justify-between">
                <h2 className="text-4xl font-black text-slate-500">Registra Producto</h2>
                <Link
                    to='/'
